...
class RBTreeMap:
    ...
    def _rebalance(self, x):
        ...
        if px == ppx.left:
            if x == px.left:
                mid = self._transfer_directly(parent, x, px, ppx, x.left, x.right, px.right, ppx.right)
            else:
                mid = self._transfer_directly(parent, px, x, ppx, px.left, x.left, x.right, ppx.right)
        else:
            if x == px.right:
                mid = self._transfer_directly(parent, ppx, px, x, ppx.left, px.left, x.left, x.right)
            else:
                mid = self._transfer_directly(parent, ppx, x, px, ppx.left, x.left, x.right, px.right)
